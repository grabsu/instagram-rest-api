...
from app.services.uploaders import photo_upload_story_as_video, photo_upload_story_as_photo, photo_upload_post
from app.api.dependencies import ClientStorage, get_clients
...
async def photo_upload_by_url(sessionid: str = Form(...),
                              url: AnyHttpUrl = Form(...),
                              caption: str = Form(...),
                              upload_id: Optional[str] = Form(""),
                              usertags: Optional[List[str]] = Form([]),
